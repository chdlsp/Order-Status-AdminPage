...
public class PartnerApiLogicService extends BaseService<PartnerApiRequest, PartnerApiResponse, Partner> {
    ...
    @Override
    public Header<PartnerApiResponse> create(Header<PartnerApiRequest> ApiRequest) {
        return null;
    }
    ...
    @Override
    public Header<PartnerApiResponse> update(Header<PartnerApiRequest> ApiRequest) {
        return null;
    }
